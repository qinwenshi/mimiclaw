...
#define MIMI_HEARTBEAT_TASK_STACK    (4 * 1024)
#define MIMI_HEARTBEAT_TASK_PRIO     4
#define MIMI_HEARTBEAT_TASK_CORE     0
...
#define MIMI_NVS_KEY_OPENAI_API_URL  "openai_url"
